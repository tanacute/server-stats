...
About: Version & Support
    ...
    JavaScript API Version 85634-85634.
    ...
    var Nirvana = (function () {
        ...
        var Utils = (function () {
            ...
            function isCrossDomainProxyMessage(messageData){
                ...
                if (messageComponents.length > 0){
                    if (messageComponents[0].substring(0, 33) == 'EVENTSOURCE_STREAMING_POSTMESSAGE'){
                        return true;
                    }
                }
                return false;
        ...
        var Transport = (function () {
            ...
            function resetSession(reason) {
                ...
                if (sessionStatus === Statuses.CONNECTING) {
                    realmRecoveryAttemptCount++;
                    if (Utils.isLoggingEnabled()) {
                        Utils.Logger.log(6, "[Transport] Recreating Driver to CONNECT. Delaying open() for " + delayFor + "ms");
                    }
                    setTimeout(open, delayFor); // recreate the driver which will trigger the outbound engine and send the init request
                }
                ...
                if (currentSession.getStatus() === Statuses.RECONNECTING) {
                    realmRecoveryAttemptCount++;
                    ...
                    if (Utils.isLoggingEnabled()) {
                        Utils.Logger.log(6, "[Transport] Recreating Driver to RECONNECT. Delaying open() for " + delayFor + "ms");
                    }
    ...
    /*
        ...
        */
        ...
        return {
            ...
            "VERSION_NUMBER":"9.12.0.0",
            "BUILD_NUMBER":"85634-85634",
            "BUILD_DATE":"August 26 2016",
